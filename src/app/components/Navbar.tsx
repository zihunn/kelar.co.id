            ...
            <div className="text-center">
              ...
              <div className="bg-white/5 rounded-xl md:rounded-2xl p-4 md:p-6 mb-8 md:mb-10 border border-white/10">
                <p className="text-white/80 text-base md:text-lg leading-relaxed">
                  {t("common.consultationDesc")} <span className="text-white font-bold">{t("common.consultationMinutes")}</span>.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 md:gap-4">
                <a
                  ...
                  onClick={() => api.logAnalytics({ category: 'conversion', action: 'click', label: 'whatsapp_click', metadata: { source: 'navbar_modal' } })}
                ...
                >
                  ...
                  <span>{t("common.consultationNow")}</span>
                </a>
