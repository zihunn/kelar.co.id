...
export function Navbar() {
  ...
  return (
    <>
      <nav className="bg-[#002d4f]/95 dark:bg-background/90 backdrop-blur-md border-b border-white/10 fixed top-0 left-0 right-0 z-50 transition-all">
          ...
          <div className="flex justify-between items-center h-16 md:h-24">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="relative group/nav">
                ...
                {/* Dropdown Menu */}
                <div className="absolute top-full left-0 w-96 bg-[#002d4f]/95 dark:bg-background/95 backdrop-blur-2xl border border-white/10 rounded-3xl p-4 opacity-0 invisible group-hover/nav:opacity-100 group-hover/nav:visible transition-all duration-300 translate-y-2 group-hover/nav:translate-y-0 shadow-2xl">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#002d4f] dark:bg-background border-t border-white/10">
      ...
      {isConsultationModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          />
          <div className="relative bg-[#002d4f] dark:bg-slate-900 border border-white/20 rounded-[2.5rem] w-full max-w-lg p-8 md:p-12 shadow-2xl animate-in zoom-in-95 duration-200">
            <button 
              onClick={() => setIsConsultationModalOpen(false)}
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-white/10 rounded-3xl flex items-center justify-center mx-auto mb-8 border border-white/10">
                <Menu className="text-blue-400" size={40} />
              </div>
              ...
              <div className="flex flex-col gap-4">
                <a
                  ...
                  className="w-full py-5 bg-white text-[#002d4f] rounded-full font-black text-xl hover:bg-white/90 transition-all shadow-xl flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98]"
                >
                ...
                <button 
                  onClick={() => setIsConsultationModalOpen(false)}
                  className="py-4 text-white/40 hover:text-white transition-colors text-sm font-bold tracking-widest uppercase"
                >
                  Nanti Saja
                </button>
              </div>
